...
<body>
	...
	<div>
		<!-- <h2>Welcome <?php echo "$empName"; ?> </h2> -->
		    	...
		    	<h2 style="font-family: 'Montserrat', sans-serif; font-size: 25px; text-align: center;">Farm Sections Existing </h2>
    	<table>
			...
			<?php
				...
				while ($section = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<td><a href=\"editViewSections.php?id=$section[id]\">Edit</a> | <a href=\"deleteViewSections.php?id=$section[id]\" onClick=\"return confirm('Are you sure you want to delete this section?')\">Delete</a></td>";
