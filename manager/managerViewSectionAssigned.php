    	...
    	<table>
			...
			<?php
				...
				while ($section = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<td><a href=\"editViewSections.php?id=$section[id]\">Harvested</a> | <a href=\"deleteViewSections.php?id=$section[id]\" onClick=\"return confirm('Are you sure you want to delete this section?')\">Delete</a></td>";
