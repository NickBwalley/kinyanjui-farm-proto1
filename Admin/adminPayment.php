...
if (isset($_POST['approve'])) {
    ...
    if (mysqli_query($conn, $sql1) && mysqli_query($conn, $sql2)) {
        ...
        header("Location: adminSalaryTable.php?id=$admID");
    } else {
        // At least one update failed, roll back the transaction
        mysqli_rollback($conn);
        echo "Error updating record: " . mysqli_error($conn);
        header("Location: adminPayment.php?id=$admID");
    }
}
        ...
        <div class="wrapper wrapper--w680">
            <div class="card card-1">
                ...
                <div class="card-body">
                    ...
                    <form id = "registration" action="adminPayment.php?id=<?php echo $admID?>"" method="POST">
