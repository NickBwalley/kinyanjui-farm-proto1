    ...
    <header>
        <nav>
            ...
            <ul id="navli">
                ...
                <li><a class="homered" href="adminAddEmployee.php?id=<?php echo $id?>"">Add Employee</a></li>
                <li><a class="homeback" href="adminViewEmployee.php?id=<?php echo $id?>"">View Employee</a></li>
        ...
        <div class="wrapper wrapper--w680">
            <div class="card card-1">
                ...
                <div class="card-body">
                    ...
                    <form action="process/adminEmployeeProcess.php" method="POST" enctype="multipart/form-data">
