...
-- Procedures
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `complaintreceivedandresolved` ()   BEGIN
    SELECT
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `CUSTOMERSASTIFICATIONINDEX` ()   BEGIN
    SELECT
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `EmployeesTraining` ()   BEGIN
    SELECT
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `FarmProductivity` ()   BEGIN
    SELECT
        year,
        productivity_index
    FROM
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `GetProfitTrends` ()   BEGIN
    SELECT
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `PROCESSINGMANUFACTURE` ()   BEGIN
    SELECT
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `QualityProcess` ()   BEGIN
    SELECT
        category_column AS category,
...
CREATE TABLE `complaints` (
  ...
  `complaint_received` int(11) DEFAULT NULL,
  `complaint_resolved` int(11) DEFAULT NULL,
  `complaint_severity` int(11) DEFAULT NULL
...
INSERT INTO `complaints` (`complaint_id`, `complaint_received`, `complaint_resolved`, `complaint_severity`) VALUES
(1, 10, 7, 3),
(2, 15, 12, 2),
(3, 20, 18, 4),
(4, 8, 5, 2),
...
(363, 'Online Diecast Creations Co.', 'Young', 'Dorothy', '6035558647', '2304 Long Airport Avenue', NULL, 'Nashua', 'NH', '62023', 'USA', 1216, 114200.00),
...
CREATE TABLE `customer_satisfaction` (
  ...
  `customer_satisfaction_index` float DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `employees` (
  ...
  `is_trained` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `employees` (`employeeNumber`, `lastName`, `firstName`, `extension`, `email`, `officeCode`, `reportsTo`, `jobTitle`, `is_trained`) VALUES
(1002, 'Murphy', 'Diane', 'x5800', 'dmurphy@classicmodelcars.com', '1', NULL, 'President', 0),
...
(1102, 'Bondur', 'Gerard', 'x5408', 'gbondur@classicmodelcars.com', '4', 1056, 'Sale Manager (EMEA)', 1),
...
CREATE TABLE `employeetraining` (
  ...
  `training_topic` varchar(50) DEFAULT NULL,
...
INSERT INTO `employeetraining` (`training_id`, `training_topic`, `training_hours`) VALUES
(1, 'Topic A', 15),
(2, 'Topic B', 20),
(3, 'Topic C', 10),
(4, 'Topic D', 12),
...
CREATE TABLE `orders` (
  ...
  `customerNumber` int(11) NOT NULL,
  `number_of_kgs_harvested` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `orders` (`orderNumber`, `orderDate`, `requiredDate`, `shippedDate`, `status`, `comments`, `customerNumber`, `number_of_kgs_harvested`) VALUES
(10100, '2021-01-06', '2021-01-13', '2021-01-10', 'Shipped', NULL, 363, 4655),
(10101, '2021-01-09', '2021-01-18', '2021-01-11', 'Shipped', 'Check on availability.', 128, 4763),
(10102, '2021-01-10', '2021-01-18', '2021-01-14', 'Shipped', NULL, 181, 4847),
(10103, '2021-01-29', '2021-02-07', '2021-02-02', 'Shipped', NULL, 121, 4947),
(10104, '2021-01-31', '2021-02-09', '2021-02-01', 'Shipped', NULL, 141, 196),
(10105, '2021-02-11', '2021-02-21', '2021-02-12', 'Shipped', NULL, 145, 1140),
(10106, '2021-02-17', '2021-02-24', '2021-02-21', 'Shipped', NULL, 278, 111),
(10107, '2021-02-24', '2021-03-03', '2021-02-26', 'Shipped', 'Difficult to negotiate with customer. We need more marketing materials', 131, 2136),
(10108, '2021-03-03', '2021-03-12', '2021-03-08', 'Shipped', NULL, 385, 347),
(10109, '2021-03-10', '2021-03-19', '2021-03-11', 'Shipped', 'Customer requested that FedEx Ground is used for this shipping', 486, 328),
(10110, '2021-03-18', '2021-03-24', '2021-03-20', 'Shipped', NULL, 187, 601),
(10111, '2021-03-25', '2021-03-31', '2021-03-30', 'Shipped', NULL, 129, 2020),
(10112, '2021-03-24', '2021-04-03', '2021-03-29', 'Shipped', 'Customer requested that ad materials (such as posters, pamphlets) be included in the shippment', 144, 3299),
(10113, '2021-03-26', '2021-04-02', '2021-03-27', 'Shipped', NULL, 124, 435),
(10114, '2021-04-01', '2021-04-07', '2021-04-02', 'Shipped', NULL, 172, 2279),
(10115, '2021-04-04', '2021-04-12', '2021-04-07', 'Shipped', NULL, 424, 90),
(10116, '2021-04-11', '2021-04-19', '2021-04-13', 'Shipped', NULL, 381, 3614),
(10117, '2021-04-16', '2021-04-24', '2021-04-17', 'Shipped', NULL, 148, 2801),
(10118, '2021-04-21', '2021-04-29', '2021-04-26', 'Shipped', 'Customer has worked with some of our vendors in the past and is aware of their MSRP', 216, 3163),
(10119, '2021-04-28', '2021-05-05', '2021-05-02', 'Shipped', NULL, 382, 2413),
(10120, '2021-04-29', '2021-05-08', '2021-05-01', 'Shipped', NULL, 114, 2575),
(10121, '2021-05-07', '2021-05-13', '2021-05-13', 'Shipped', NULL, 353, 636),
(10122, '2021-05-08', '2021-05-16', '2021-05-13', 'Shipped', NULL, 350, 455),
(10123, '2021-05-20', '2021-05-29', '2021-05-22', 'Shipped', NULL, 103, 370),
(10124, '2021-05-21', '2021-05-29', '2021-05-25', 'Shipped', 'Customer very concerned about the exact color of the models. There is high risk that he may dispute the order because there is a slight color mismatch', 112, 486),
(10125, '2021-05-21', '2021-05-27', '2021-05-24', 'Shipped', NULL, 114, 1317),
(10126, '2021-05-28', '2021-06-07', '2021-06-02', 'Shipped', NULL, 458, 131),
(10127, '2021-06-03', '2021-06-09', '2021-06-06', 'Shipped', 'Customer requested special shippment. The instructions were passed along to the warehouse', 151, 1703),
(10128, '2021-06-06', '2021-06-12', '2021-06-11', 'Shipped', NULL, 141, 3123),
(10129, '2021-06-12', '2021-06-18', '2021-06-14', 'Shipped', NULL, 324, 504),
(10130, '2021-06-16', '2021-06-24', '2021-06-21', 'Shipped', NULL, 198, 3155),
(10131, '2021-06-16', '2021-06-25', '2021-06-21', 'Shipped', NULL, 447, 4261),
(10132, '2021-06-25', '2021-07-01', '2021-06-28', 'Shipped', NULL, 323, 1839),
(10133, '2021-06-27', '2021-07-04', '2021-07-03', 'Shipped', NULL, 141, 1416),
(10134, '2021-07-01', '2021-07-10', '2021-07-05', 'Shipped', NULL, 250, 1560),
(10135, '2021-07-02', '2021-07-12', '2021-07-03', 'Shipped', NULL, 124, 3556),
(10136, '2021-07-04', '2021-07-14', '2021-07-06', 'Shipped', 'Customer is interested in buying more Ferrari models', 242, 3099),
(10137, '2021-07-10', '2021-07-20', '2021-07-14', 'Shipped', NULL, 353, 4826),
(10138, '2021-07-07', '2021-07-16', '2021-07-13', 'Shipped', NULL, 496, 4833),
(10139, '2021-07-16', '2021-07-23', '2021-07-21', 'Shipped', NULL, 282, 4687),
(10140, '2021-07-24', '2021-08-02', '2021-07-30', 'Shipped', NULL, 161, 3935),
(10141, '2021-08-01', '2021-08-09', '2021-08-04', 'Shipped', NULL, 334, 618),
(10142, '2021-08-08', '2021-08-16', '2021-08-13', 'Shipped', NULL, 124, 1286),
(10143, '2021-08-10', '2021-08-18', '2021-08-12', 'Shipped', 'Can we deliver the new Ford Mustang models by end-of-quarter?', 320, 4576),
(10144, '2021-08-13', '2021-08-21', '2021-08-14', 'Shipped', NULL, 381, 4024),
(10145, '2021-08-25', '2021-09-02', '2021-08-31', 'Shipped', NULL, 205, 1391),
(10146, '2021-09-03', '2021-09-13', '2021-09-06', 'Shipped', NULL, 447, 4883),
(10147, '2021-09-05', '2021-09-12', '2021-09-09', 'Shipped', NULL, 379, 243),
(10148, '2021-09-11', '2021-09-21', '2021-09-15', 'Shipped', 'They want to reevaluate their terms agreement with Finance.', 276, 1565),
(10149, '2021-09-12', '2021-09-18', '2021-09-17', 'Shipped', NULL, 487, 2096),
(10150, '2021-09-19', '2021-09-27', '2021-09-21', 'Shipped', 'They want to reevaluate their terms agreement with Finance.', 148, 786),
(10151, '2021-09-21', '2021-09-30', '2021-09-24', 'Shipped', NULL, 311, 2642),
(10152, '2021-09-25', '2021-10-03', '2021-10-01', 'Shipped', NULL, 333, 853),
(10153, '2021-09-28', '2021-10-05', '2021-10-03', 'Shipped', NULL, 141, 1339),
(10154, '2021-10-02', '2021-10-12', '2021-10-08', 'Shipped', NULL, 219, 4138),
(10155, '2021-10-06', '2021-10-13', '2021-10-07', 'Shipped', NULL, 186, 1675),
(10156, '2021-10-08', '2021-10-17', '2021-10-11', 'Shipped', NULL, 141, 958),
(10157, '2021-10-09', '2021-10-15', '2021-10-14', 'Shipped', NULL, 473, 4769),
(10158, '2021-10-10', '2021-10-18', '2021-10-15', 'Shipped', NULL, 121, 970),
(10159, '2021-10-10', '2021-10-19', '2021-10-16', 'Shipped', NULL, 321, 543),
(10160, '2021-10-11', '2021-10-17', '2021-10-17', 'Shipped', NULL, 347, 4807),
(10161, '2021-10-17', '2021-10-25', '2021-10-20', 'Shipped', NULL, 227, 2404),
(10162, '2021-10-18', '2021-10-26', '2021-10-19', 'Shipped', NULL, 321, 2602),
(10163, '2021-10-20', '2021-10-27', '2021-10-24', 'Shipped', NULL, 424, 798),
(10164, '2021-10-21', '2021-10-30', '2021-10-23', 'Resolved', 'This order was disputed, but resolved on 11/1/2021; Customer doesn\'t like the colors and precision of the models.', 452, 1184),
(10165, '2021-10-22', '2021-10-31', '2021-12-26', 'Shipped', 'This order was on hold because customers\'s credit limit had been exceeded. Order will ship when payment is received', 148, 3528),
(10166, '2021-10-21', '2021-10-30', '2021-10-27', 'Shipped', NULL, 462, 4086),
(10167, '2021-10-23', '2021-10-30', NULL, 'Cancelled', 'Customer called to cancel. The warehouse was notified in time and the order didn\'t ship. They have a new VP of Sales and are shifting their sales model. Our VP of Sales should contact them.', 448, 4849),
(10168, '2021-10-28', '2021-11-03', '2021-11-01', 'Shipped', NULL, 161, 1985),
(10169, '2021-11-04', '2021-11-14', '2021-11-09', 'Shipped', NULL, 276, 381),
(10170, '2021-11-04', '2021-11-12', '2021-11-07', 'Shipped', NULL, 452, 949),
(10171, '2021-11-05', '2021-11-13', '2021-11-07', 'Shipped', NULL, 233, 3604),
(10172, '2021-11-05', '2021-11-14', '2021-11-11', 'Shipped', NULL, 175, 174),
(10173, '2021-11-05', '2021-11-15', '2021-11-09', 'Shipped', 'Cautious optimism. We have happy customers here, if we can keep them well stocked.  I need all the information I can get on the planned shippments of Porches', 278, 57),
(10174, '2021-11-06', '2021-11-15', '2021-11-10', 'Shipped', NULL, 333, 4765),
(10175, '2021-11-06', '2021-11-14', '2021-11-09', 'Shipped', NULL, 324, 3654),
(10176, '2021-11-06', '2021-11-15', '2021-11-12', 'Shipped', NULL, 386, 3974),
(10177, '2021-11-07', '2021-11-17', '2021-11-12', 'Shipped', NULL, 344, 3910),
(10178, '2021-11-08', '2021-11-16', '2021-11-10', 'Shipped', 'Custom shipping instructions sent to warehouse', 242, 2628),
(10179, '2021-11-11', '2021-11-17', '2021-11-13', 'Cancelled', 'Customer cancelled due to urgent budgeting issues. Must be cautious when dealing with them in the future. Since order shipped already we must discuss who would cover the shipping charges.', 496, 1409),
(10180, '2021-11-11', '2021-11-19', '2021-11-14', 'Shipped', NULL, 171, 4162),
(10181, '2021-11-12', '2021-11-19', '2021-11-15', 'Shipped', NULL, 167, 1583),
(10182, '2021-11-12', '2021-11-21', '2021-11-18', 'Shipped', NULL, 124, 430),
(10183, '2021-11-13', '2021-11-22', '2021-11-15', 'Shipped', 'We need to keep in close contact with their Marketing VP. He is the decision maker for all their purchases.', 339, 2401),
(10184, '2021-11-14', '2021-11-22', '2021-11-20', 'Shipped', NULL, 484, 715),
(10185, '2021-11-14', '2021-11-21', '2021-11-20', 'Shipped', NULL, 320, 1374),
(10186, '2021-11-14', '2021-11-20', '2021-11-18', 'Shipped', 'They want to reevaluate their terms agreement with the VP of Sales', 489, 4726),
(10187, '2021-11-15', '2021-11-24', '2021-11-16', 'Shipped', NULL, 211, 4508),
(10188, '2021-11-18', '2021-11-26', '2021-11-24', 'Shipped', NULL, 167, 3362),
(10189, '2021-11-18', '2021-11-25', '2021-11-24', 'Shipped', 'They want to reevaluate their terms agreement with Finance.', 205, 3288),
(10190, '2021-11-19', '2021-11-29', '2021-11-20', 'Shipped', NULL, 141, 1354),
(10191, '2021-11-20', '2021-11-30', '2021-11-24', 'Shipped', 'We must be cautions with this customer. Their VP of Sales resigned. Company may be heading down.', 259, 1906),
(10192, '2021-11-20', '2021-11-29', '2021-11-25', 'Shipped', NULL, 363, 467),
(10193, '2021-11-21', '2021-11-28', '2021-11-27', 'Shipped', NULL, 471, 1617),
(10194, '2021-11-25', '2021-12-02', '2021-11-26', 'Shipped', NULL, 146, 1687),
(10195, '2021-11-25', '2021-12-01', '2021-11-28', 'Shipped', NULL, 319, 3584),
(10196, '2021-11-26', '2021-12-03', '2021-12-01', 'Shipped', NULL, 455, 2859),
(10197, '2021-11-26', '2021-12-02', '2021-12-01', 'Shipped', 'Customer inquired about remote controlled models and gold models.', 216, 3545),
(10198, '2021-11-27', '2021-12-06', '2021-12-03', 'Shipped', NULL, 385, 4146),
(10199, '2021-12-01', '2021-12-10', '2021-12-06', 'Shipped', NULL, 475, 95),
(10200, '2021-12-01', '2021-12-09', '2021-12-06', 'Shipped', NULL, 211, 3037),
(10201, '2021-12-01', '2021-12-11', '2021-12-02', 'Shipped', NULL, 129, 4903),
(10202, '2021-12-02', '2021-12-09', '2021-12-06', 'Shipped', NULL, 357, 403),
(10203, '2021-12-02', '2021-12-11', '2021-12-07', 'Shipped', NULL, 141, 2305),
(10204, '2021-12-02', '2021-12-10', '2021-12-04', 'Shipped', NULL, 151, 320),
(10205, '2021-12-03', '2021-12-09', '2021-12-07', 'Shipped', ' I need all the information I can get on our competitors.', 141, 4682),
(10206, '2021-12-05', '2021-12-13', '2021-12-08', 'Shipped', 'Can we renegotiate this one?', 202, 2452),
(10207, '2021-12-09', '2021-12-17', '2021-12-11', 'Shipped', 'Check on availability.', 495, 3215),
(10208, '2022-01-02', '2022-01-11', '2022-01-04', 'Shipped', NULL, 146, 3720),
(10209, '2022-01-09', '2022-01-15', '2022-01-12', 'Shipped', NULL, 347, 3954),
(10210, '2022-01-12', '2022-01-22', '2022-01-20', 'Shipped', NULL, 177, 3610),
(10211, '2022-01-15', '2022-01-25', '2022-01-18', 'Shipped', NULL, 406, 1189),
(10212, '2022-01-16', '2022-01-24', '2022-01-18', 'Shipped', NULL, 141, 114),
(10213, '2022-01-22', '2022-01-28', '2022-01-27', 'Shipped', 'Difficult to negotiate with customer. We need more marketing materials', 489, 2004),
(10214, '2022-01-26', '2022-02-04', '2022-01-29', 'Shipped', NULL, 458, 4679),
(10215, '2022-01-29', '2022-02-08', '2022-02-01', 'Shipped', 'Customer requested that FedEx Ground is used for this shipping', 475, 2386),
(10216, '2022-02-02', '2022-02-10', '2022-02-04', 'Shipped', NULL, 256, 2890),
(10217, '2022-02-04', '2022-02-14', '2022-02-06', 'Shipped', NULL, 166, 2293),
(10218, '2022-02-09', '2022-02-16', '2022-02-11', 'Shipped', 'Customer requested that ad materials (such as posters, pamphlets) be included in the shippment', 473, 2797),
(10219, '2022-02-10', '2022-02-17', '2022-02-12', 'Shipped', NULL, 487, 2106),
(10220, '2022-02-12', '2022-02-19', '2022-02-16', 'Shipped', NULL, 189, 2141),
(10221, '2022-02-18', '2022-02-26', '2022-02-19', 'Shipped', NULL, 314, 4385),
(10222, '2022-02-19', '2022-02-27', '2022-02-20', 'Shipped', NULL, 239, 504),
(10223, '2022-02-20', '0000-00-00', '2022-02-24', 'Shipped', NULL, 114, 4366),
(10224, '2022-02-21', '2022-03-02', '2022-02-26', 'Shipped', 'Customer has worked with some of our vendors in the past and is aware of their MSRP', 171, 318),
(10225, '2022-02-22', '2022-03-01', '2022-02-24', 'Shipped', NULL, 298, 3493),
(10226, '2022-02-26', '2022-03-06', '2022-03-02', 'Shipped', NULL, 239, 1511),
(10227, '2022-03-02', '2022-03-12', '2022-03-08', 'Shipped', NULL, 146, 2079),
(10228, '2022-03-10', '2022-03-18', '2022-03-13', 'Shipped', NULL, 173, 859),
(10229, '2022-03-11', '2022-03-20', '2022-03-12', 'Shipped', NULL, 124, 3061),
(10230, '2022-03-15', '2022-03-24', '2022-03-20', 'Shipped', 'Customer very concerned about the exact color of the models. There is high risk that he may dispute the order because there is a slight color mismatch', 128, 2727),
(10231, '2022-03-19', '2022-03-26', '2022-03-25', 'Shipped', NULL, 344, 4453),
(10232, '2022-03-20', '2022-03-30', '2022-03-25', 'Shipped', NULL, 240, 4086),
(10233, '2022-03-29', '2022-04-04', '2022-04-02', 'Shipped', 'Customer requested special shippment. The instructions were passed along to the warehouse', 328, 2070),
(10234, '2022-03-30', '2022-04-05', '2022-04-02', 'Shipped', NULL, 412, 3094),
(10235, '2022-04-02', '2022-04-12', '2022-04-06', 'Shipped', NULL, 260, 4260),
(10236, '2022-04-03', '2022-04-11', '2022-04-08', 'Shipped', NULL, 486, 2017),
(10237, '2022-04-05', '2022-04-12', '2022-04-10', 'Shipped', NULL, 181, 2307),
(10238, '2022-04-09', '2022-04-16', '2022-04-10', 'Shipped', NULL, 145, 485),
(10239, '2022-04-12', '2022-04-21', '2022-04-17', 'Shipped', NULL, 311, 505),
(10240, '2022-04-13', '2022-04-20', '2022-04-20', 'Shipped', NULL, 177, 1069),
(10241, '2022-04-13', '2022-04-20', '2022-04-19', 'Shipped', NULL, 209, 3831),
(10242, '2022-04-20', '2022-04-28', '2022-04-25', 'Shipped', 'Customer is interested in buying more Ferrari models', 456, 948),
(10243, '2022-04-26', '2022-05-03', '2022-04-28', 'Shipped', NULL, 495, 3247),
(10244, '2022-04-29', '2022-05-09', '2022-05-04', 'Shipped', NULL, 141, 3390),
(10245, '2022-05-04', '2022-05-12', '2022-05-09', 'Shipped', NULL, 455, 2211),
(10246, '2022-05-05', '2022-05-13', '2022-05-06', 'Shipped', NULL, 141, 886),
(10247, '2022-05-05', '2022-05-11', '2022-05-08', 'Shipped', NULL, 334, 2795),
(10248, '2022-05-07', '2022-05-14', NULL, 'Cancelled', 'Order was mistakenly placed. The warehouse noticed the lack of documentation.', 131, 1320),
(10249, '2022-05-08', '2022-05-17', '2022-05-11', 'Shipped', 'Can we deliver the new Ford Mustang models by end-of-quarter?', 173, 3216),
(10250, '2022-05-11', '2022-05-19', '2022-05-15', 'Shipped', NULL, 450, 2122),
(10251, '2022-05-18', '2022-05-24', '2022-05-24', 'Shipped', NULL, 328, 960),
(10252, '2022-05-26', '2022-06-04', '2022-05-29', 'Shipped', NULL, 406, 3433),
(10253, '2022-06-01', '2022-06-09', '2022-06-02', 'Cancelled', 'Customer disputed the order and we agreed to cancel it. We must be more cautions with this customer going forward, since they are very hard to please. We must cover the shipping fees.', 201, 4289),
(10254, '2022-06-03', '2022-06-13', '2022-06-04', 'Shipped', 'Customer requested that DHL is used for this shipping', 323, 1143),
(10255, '2022-06-04', '2022-06-12', '2022-06-09', 'Shipped', NULL, 209, 2851),
(10256, '2022-06-08', '2022-06-16', '2022-06-10', 'Shipped', NULL, 145, 827),
(10257, '2022-06-14', '2022-06-24', '2022-06-15', 'Shipped', NULL, 450, 582),
(10258, '2022-06-15', '2022-06-25', '2022-06-23', 'Shipped', NULL, 398, 427),
(10259, '2022-06-15', '2022-06-22', '2022-06-17', 'Shipped', NULL, 166, 392),
(10260, '2022-06-16', '2022-06-22', NULL, 'Cancelled', 'Customer heard complaints from their customers and called to cancel this order. Will notify the Sales Manager.', 357, 678),
(10261, '2022-06-17', '2022-06-25', '2022-06-22', 'Shipped', NULL, 233, 2217),
(10262, '2022-06-24', '2022-07-01', NULL, 'Cancelled', 'This customer found a better offer from one of our competitors. Will call back to renegotiate.', 141, 4050),
(10263, '2022-06-28', '2022-07-04', '2022-07-02', 'Shipped', NULL, 175, 3598),
(10264, '2022-06-30', '2022-07-06', '2022-07-01', 'Shipped', 'Customer will send a truck to our local warehouse on 7/1/2022', 362, 842),
(10265, '2022-07-02', '2022-07-09', '2022-07-07', 'Shipped', NULL, 471, 3418),
(10266, '2022-07-06', '2022-07-14', '2022-07-10', 'Shipped', NULL, 386, 4565),
(10267, '2022-07-07', '2022-07-17', '2022-07-09', 'Shipped', NULL, 151, 2568),
(10268, '2022-07-12', '2022-07-18', '2022-07-14', 'Shipped', NULL, 412, 4148),
(10269, '2022-07-16', '2022-07-22', '2022-07-18', 'Shipped', NULL, 382, 3037),
(10270, '2022-07-19', '2022-07-27', '2022-07-24', 'Shipped', 'Can we renegotiate this one?', 282, 2741),
(10271, '2022-07-20', '2022-07-29', '2022-07-23', 'Shipped', NULL, 124, 4595),
(10272, '2022-07-20', '2022-07-26', '2022-07-22', 'Shipped', NULL, 157, 4754),
(10273, '2022-07-21', '2022-07-28', '2022-07-22', 'Shipped', NULL, 314, 4984),
(10274, '2022-07-21', '2022-07-29', '2022-07-22', 'Shipped', NULL, 379, 660),
(10275, '2022-07-23', '2022-08-02', '2022-07-29', 'Shipped', NULL, 119, 3348),
(10276, '2022-08-02', '2022-08-11', '2022-08-08', 'Shipped', NULL, 204, 4760),
(10277, '2022-08-04', '2022-08-12', '2022-08-05', 'Shipped', NULL, 148, 3755),
(10278, '2022-08-06', '2022-08-16', '2022-08-09', 'Shipped', NULL, 112, 4495),
(10279, '2022-08-09', '2022-08-19', '2022-08-15', 'Shipped', 'Cautious optimism. We have happy customers here, if we can keep them well stocked.  I need all the information I can get on the planned shippments of Porches', 141, 1211),
(10280, '2022-08-17', '2022-08-27', '2022-08-19', 'Shipped', NULL, 249, 2571),
(10281, '2022-08-19', '2022-08-28', '2022-08-23', 'Shipped', NULL, 157, 4221),
(10282, '2022-08-20', '2022-08-26', '2022-08-22', 'Shipped', NULL, 124, 3395),
(10283, '2022-08-20', '2022-08-30', '2022-08-23', 'Shipped', NULL, 260, 4312),
(10284, '2022-08-21', '2022-08-29', '2022-08-26', 'Shipped', 'Custom shipping instructions sent to warehouse', 299, 1374),
(10285, '2022-08-27', '2022-09-04', '2022-08-31', 'Shipped', NULL, 286, 3936),
(10286, '2022-08-28', '2022-09-06', '2022-09-01', 'Shipped', NULL, 172, 560),
(10287, '2022-08-30', '2022-09-06', '2022-09-01', 'Shipped', NULL, 298, 991),
(10288, '2022-09-01', '2022-09-11', '2022-09-05', 'Shipped', NULL, 166, 3274),
(10289, '2022-09-03', '2022-09-13', '2022-09-04', 'Shipped', 'We need to keep in close contact with their Marketing VP. He is the decision maker for all their purchases.', 167, 3398),
(10290, '2022-09-07', '2022-09-15', '2022-09-13', 'Shipped', NULL, 198, 2170),
(10291, '2022-09-08', '2022-09-17', '2022-09-14', 'Shipped', NULL, 448, 657),
(10292, '2022-09-08', '2022-09-18', '2022-09-11', 'Shipped', 'They want to reevaluate their terms agreement with Finance.', 131, 1776),
(10293, '2022-09-09', '2022-09-18', '2022-09-14', 'Shipped', NULL, 249, 1907),
(10294, '2022-09-10', '2022-09-17', '2022-09-14', 'Shipped', NULL, 204, 4208),
(10295, '2022-09-10', '2022-09-17', '2022-09-14', 'Shipped', 'They want to reevaluate their terms agreement with Finance.', 362, 322),
(10296, '2022-09-15', '2022-09-22', '2022-09-16', 'Shipped', NULL, 415, 3983),
(10297, '2022-09-16', '2022-09-22', '2022-09-21', 'Shipped', 'We must be cautions with this customer. Their VP of Sales resigned. Company may be heading down.', 189, 3953),
(10298, '2022-09-27', '2022-10-05', '2022-10-01', 'Shipped', NULL, 103, 2815),
(10299, '2022-09-30', '2022-10-10', '2022-10-01', 'Shipped', NULL, 186, 2217),
(10300, '2021-10-04', '2021-10-13', '2021-10-09', 'Shipped', NULL, 128, 2639),
(10301, '2021-10-05', '2021-10-15', '2021-10-08', 'Shipped', NULL, 299, 1547),
(10302, '2021-10-06', '2021-10-16', '2021-10-07', 'Shipped', NULL, 201, 4818),
(10303, '2022-10-06', '2022-10-14', '2022-10-09', 'Shipped', 'Customer inquired about remote controlled models and gold models.', 484, 4450),
(10304, '2022-10-11', '2022-10-20', '2022-10-17', 'Shipped', NULL, 256, 2796),
(10305, '2022-10-13', '2022-10-22', '2022-10-15', 'Shipped', 'Check on availability.', 286, 629),
(10306, '2022-10-14', '2022-10-21', '2022-10-17', 'Shipped', NULL, 187, 4756),
(10307, '2022-10-14', '2022-10-23', '2022-10-20', 'Shipped', NULL, 339, 1897),
(10308, '2022-10-15', '2022-10-24', '2022-10-20', 'Shipped', 'Customer requested that FedEx Ground is used for this shipping', 319, 216),
(10309, '2022-10-15', '2022-10-24', '2022-10-18', 'Shipped', NULL, 121, 388),
(10310, '2022-10-16', '2022-10-24', '2022-10-18', 'Shipped', NULL, 259, 1292),
(10311, '2022-10-16', '2022-10-23', '2022-10-20', 'Shipped', 'Difficult to negotiate with customer. We need more marketing materials', 141, 296),
(10312, '2022-10-21', '2022-10-27', '2022-10-23', 'Shipped', NULL, 124, 2607),
(10313, '2022-10-22', '2022-10-28', '2022-10-25', 'Shipped', 'Customer requested that FedEx Ground is used for this shipping', 202, 2147),
(10314, '2022-10-22', '2022-11-01', '2022-10-23', 'Shipped', NULL, 227, 2916),
(10315, '2022-10-29', '2022-11-08', '2022-10-30', 'Shipped', NULL, 119, 3136),
(10316, '2022-11-01', '2022-11-09', '2022-11-07', 'Shipped', 'Customer requested that ad materials (such as posters, pamphlets) be included in the shippment', 240, 1935),
(10317, '2022-11-02', '2022-11-12', '2022-11-08', 'Shipped', NULL, 161, 267),
(10318, '2022-11-02', '2022-11-09', '2022-11-07', 'Shipped', NULL, 157, 530),
(10319, '2022-11-03', '2022-11-11', '2022-11-06', 'Shipped', 'Customer requested that DHL is used for this shipping', 456, 1848),
(10320, '2022-11-03', '2022-11-13', '2022-11-07', 'Shipped', NULL, 144, 2653),
(10321, '2022-11-04', '2022-11-12', '2022-11-07', 'Shipped', NULL, 462, 2720),
(10322, '2022-11-04', '2022-11-12', '2022-11-10', 'Shipped', 'Customer has worked with some of our vendors in the past and is aware of their MSRP', 363, 640),
(10323, '2022-11-05', '2022-11-12', '2022-11-09', 'Shipped', NULL, 128, 44),
(10324, '2022-11-05', '2022-11-11', '2022-11-08', 'Shipped', NULL, 181, 3299),
(10325, '2022-11-05', '2022-11-13', '2022-11-08', 'Shipped', NULL, 121, 1362),
(10326, '2022-11-09', '2022-11-16', '2022-11-10', 'Shipped', NULL, 144, 1913),
(10327, '2022-11-10', '2022-11-19', '2022-11-13', 'Resolved', 'Order was disputed and resolved on 12/1/04. The Sales Manager was involved. Customer claims the scales of the models don\'t match what was discussed.', 145, 479),
(10328, '2022-11-12', '2022-11-21', '2022-11-18', 'Shipped', 'Customer very concerned about the exact color of the models. There is high risk that he may dispute the order because there is a slight color mismatch', 278, 1660),
(10329, '2022-11-15', '2022-11-24', '2022-11-16', 'Shipped', NULL, 131, 1860),
(10330, '2022-11-16', '2022-11-25', '2022-11-21', 'Shipped', NULL, 385, 4323),
(10331, '2022-11-17', '2022-11-23', '2022-11-23', 'Shipped', 'Customer requested special shippment. The instructions were passed along to the warehouse', 486, 1033),
(10332, '2022-11-17', '2022-11-25', '2022-11-18', 'Shipped', NULL, 187, 2199),
(10333, '2022-11-18', '2022-11-27', '2022-11-20', 'Shipped', NULL, 129, 2895),
(10334, '2022-11-19', '2022-11-28', NULL, 'On Hold', 'The outstaniding balance for this customer exceeds their credit limit. Order will be shipped when a payment is received.', 144, 2879),
(10335, '2022-11-19', '2022-11-29', '2022-11-23', 'Shipped', NULL, 124, 710),
(10336, '2022-11-20', '2022-11-26', '2022-11-24', 'Shipped', 'Customer requested that DHL is used for this shipping', 172, 4914),
(10337, '2022-11-21', '2022-11-30', '2022-11-26', 'Shipped', NULL, 424, 2439),
(10338, '2022-11-22', '2022-12-02', '2022-11-27', 'Shipped', NULL, 381, 2454),
(10339, '2022-11-23', '2022-11-30', '2022-11-30', 'Shipped', NULL, 398, 4955),
(10340, '2022-11-24', '2022-12-01', '2022-11-25', 'Shipped', 'Customer is interested in buying more Ferrari models', 216, 2412),
(10341, '2022-11-24', '2022-12-01', '2022-11-29', 'Shipped', NULL, 382, 2198),
(10342, '2022-11-24', '2022-12-01', '2022-11-29', 'Shipped', NULL, 114, 3752),
(10343, '2022-11-24', '2022-12-01', '2022-11-26', 'Shipped', NULL, 353, 2167),
(10344, '2022-11-25', '2022-12-02', '2022-11-29', 'Shipped', NULL, 350, 4579),
(10345, '2022-11-25', '2022-12-01', '2022-11-26', 'Shipped', NULL, 103, 1396),
(10346, '2022-11-29', '2022-12-05', '2022-11-30', 'Shipped', NULL, 112, 3242),
(10347, '2022-11-29', '2022-12-07', '2022-11-30', 'Shipped', 'Can we deliver the new Ford Mustang models by end-of-quarter?', 114, 2022),
(10348, '2022-11-01', '2022-11-08', '2022-11-05', 'Shipped', NULL, 458, 387),
(10349, '2022-12-01', '2022-12-07', '2022-12-03', 'Shipped', NULL, 151, 867),
(10350, '2022-12-02', '2022-12-08', '2022-12-05', 'Shipped', NULL, 141, 3174),
(10351, '2022-12-03', '2022-12-11', '2022-12-07', 'Shipped', NULL, 324, 3271),
(10352, '2022-12-03', '2022-12-12', '2022-12-09', 'Shipped', NULL, 198, 1831),
(10353, '2022-12-04', '2022-12-11', '2022-12-05', 'Shipped', NULL, 447, 4345),
(10354, '2022-12-04', '2022-12-10', '2022-12-05', 'Shipped', NULL, 323, 1231),
(10355, '2022-12-07', '2022-12-14', '2022-12-13', 'Shipped', NULL, 141, 3122),
(10356, '2022-12-09', '2022-12-15', '2022-12-12', 'Shipped', NULL, 250, 1915),
(10357, '2022-12-10', '2022-12-16', '2022-12-14', 'Shipped', NULL, 124, 212),
(10358, '2022-12-10', '2022-12-16', '2022-12-16', 'Shipped', 'Customer requested that DHL is used for this shipping', 141, 315),
(10359, '2022-12-15', '2022-12-23', '2022-12-18', 'Shipped', NULL, 353, 938),
(10360, '2022-12-16', '2022-12-22', '2022-12-18', 'Shipped', NULL, 496, 3747),
(10361, '2022-12-17', '2022-12-24', '2022-12-20', 'Shipped', NULL, 282, 922),
(10362, '2023-01-05', '2023-01-16', '2023-01-10', 'Shipped', NULL, 161, 3367),
(10363, '2023-01-06', '2023-01-12', '2023-01-10', 'Shipped', NULL, 334, 4072),
(10364, '2023-01-06', '2023-01-17', '2023-01-09', 'Shipped', NULL, 350, 260),
(10365, '2023-01-07', '2023-01-18', '2023-01-11', 'Shipped', NULL, 320, 4084),
(10366, '2023-01-10', '2023-01-19', '2023-01-12', 'Shipped', NULL, 381, 4641),
(10367, '2023-01-12', '2023-01-21', '2023-01-16', 'Resolved', 'This order was disputed and resolved on 2/1/2023. Customer claimed that container with shipment was damaged. FedEx\'s investigation proved this wrong.', 205, 952),
(10368, '2023-01-19', '2023-01-27', '2023-01-24', 'Shipped', 'Can we renegotiate this one?', 124, 840),
(10369, '2023-01-20', '2023-01-28', '2023-01-24', 'Shipped', NULL, 379, 1342),
(10370, '2023-01-20', '2023-02-01', '2023-01-25', 'Shipped', NULL, 276, 4190),
(10371, '2023-01-23', '2023-02-03', '2023-01-25', 'Shipped', NULL, 124, 1924),
(10372, '2023-01-26', '2023-02-05', '2023-01-28', 'Shipped', NULL, 398, 2052),
(10373, '2023-01-31', '2023-02-08', '2023-02-06', 'Shipped', NULL, 311, 4488),
(10374, '2023-02-02', '2023-02-09', '2023-02-03', 'Shipped', NULL, 333, 1286),
(10375, '2023-02-03', '2023-02-10', '2023-02-06', 'Shipped', NULL, 119, 2966),
(10376, '2023-02-08', '2023-02-18', '2023-02-13', 'Shipped', NULL, 219, 973),
(10377, '2023-02-09', '2023-02-21', '2023-02-12', 'Shipped', 'Cautious optimism. We have happy customers here, if we can keep them well stocked.  I need all the information I can get on the planned shippments of Porches', 186, 967),
(10378, '2023-02-10', '2023-02-18', '2023-02-11', 'Shipped', NULL, 141, 1916),
(10379, '2023-02-10', '2023-02-18', '2023-02-11', 'Shipped', NULL, 141, 1682),
(10380, '2023-02-16', '2023-02-24', '2023-02-18', 'Shipped', NULL, 141, 2661),
(10381, '2023-02-17', '2023-02-25', '2023-02-18', 'Shipped', NULL, 321, 3258),
(10382, '2023-02-17', '2023-02-23', '2023-02-18', 'Shipped', 'Custom shipping instructions sent to warehouse', 124, 3309),
(10383, '2023-02-22', '2023-03-02', '2023-02-25', 'Shipped', NULL, 141, 1772),
(10384, '2023-02-23', '2023-03-06', '2023-02-27', 'Shipped', NULL, 321, 3935),
(10385, '2023-02-28', '2023-03-09', '2023-03-01', 'Shipped', NULL, 124, 4358),
(10386, '2023-03-01', '2023-03-09', '2023-03-06', 'Resolved', 'Disputed then Resolved on 3/15/2023. Customer doesn\'t like the craftsmaship of the models.', 141, 4984),
(10387, '2023-03-02', '2023-03-09', '2023-03-06', 'Shipped', 'We need to keep in close contact with their Marketing VP. He is the decision maker for all their purchases.', 148, 1847),
(10388, '2023-03-03', '2023-03-11', '2023-03-09', 'Shipped', NULL, 462, 4283),
(10389, '2023-03-03', '2023-03-09', '2023-03-08', 'Shipped', NULL, 448, 876),
(10390, '2023-03-04', '2023-03-11', '2023-03-07', 'Shipped', 'They want to reevaluate their terms agreement with Finance.', 124, 1531),
(10391, '2023-03-09', '2023-03-20', '2023-03-15', 'Shipped', NULL, 276, 28),
(10392, '2023-03-10', '2023-03-18', '2023-03-12', 'Shipped', NULL, 452, 548),
(10393, '2023-03-11', '2023-03-22', '2023-03-14', 'Shipped', 'They want to reevaluate their terms agreement with Finance.', 323, 2657),
(10394, '2023-03-15', '2023-03-25', '2023-03-19', 'Shipped', NULL, 141, 1642),
(10395, '2023-03-17', '2023-03-24', '2023-03-23', 'Shipped', 'We must be cautions with this customer. Their VP of Sales resigned. Company may be heading down.', 250, 240),
(10396, '2023-03-23', '2023-04-02', '2023-03-28', 'Shipped', NULL, 124, 1273),
(10397, '2023-03-28', '2023-04-09', '2023-04-01', 'Shipped', NULL, 242, 647),
(10398, '2023-03-30', '2023-04-09', '2023-03-31', 'Shipped', NULL, 353, 4418),
(10399, '2023-04-01', '2023-04-12', '2023-04-03', 'Shipped', NULL, 496, 147),
(10400, '2023-04-01', '2023-04-11', '2023-04-04', 'Shipped', 'Customer requested that DHL is used for this shipping', 450, 2483),
(10401, '2023-04-03', '2023-04-14', NULL, 'On Hold', 'Customer credit limit exceeded. Will ship when a payment is received.', 328, 1976),
(10402, '2023-04-07', '2023-04-14', '2023-04-12', 'Shipped', NULL, 406, 2429),
(10403, '2023-04-08', '2023-04-18', '2023-04-11', 'Shipped', NULL, 201, 1217),
(10404, '2023-04-08', '2023-04-14', '2023-04-11', 'Shipped', NULL, 323, 3798),
(10405, '2023-04-14', '2023-04-24', '2023-04-20', 'Shipped', NULL, 209, 342),
(10406, '2023-04-15', '2023-04-25', '2023-04-21', 'Disputed', 'Customer claims container with shipment was damaged during shipping and some items were missing. I am talking to FedEx about this.', 145, 316),
(10407, '2023-04-22', '2023-05-04', NULL, 'On Hold', 'Customer credit limit exceeded. Will ship when a payment is received.', 450, 555),
(10408, '2023-04-22', '2023-04-29', '2023-04-27', 'Shipped', NULL, 398, 1827),
(10409, '2023-04-23', '2023-05-05', '2023-04-24', 'Shipped', NULL, 166, 2471),
(10410, '2023-04-29', '2023-05-10', '2023-04-30', 'Shipped', NULL, 357, 1875),
(10411, '2023-05-01', '2023-05-08', '2023-05-06', 'Shipped', NULL, 233, 1963),
(10412, '2023-05-03', '2023-05-13', '2023-05-05', 'Shipped', NULL, 141, 4188),
(10413, '2023-05-05', '2023-05-14', '2023-05-09', 'Shipped', 'Customer requested that DHL is used for this shipping', 175, 52),
(10414, '2023-05-06', '2023-05-13', NULL, 'On Hold', 'Customer credit limit exceeded. Will ship when a payment is received.', 362, 2698),
(10415, '2023-05-09', '2023-05-20', '2023-05-12', 'Disputed', 'Customer claims the scales of the models don\'t match what was discussed. I keep all the paperwork though to prove otherwise', 471, 3336),
(10416, '2023-05-10', '2023-05-16', '2023-05-14', 'Shipped', NULL, 386, 3583),
(10417, '2023-05-13', '2023-05-19', '2023-05-19', 'Disputed', 'Customer doesn\'t like the colors and precision of the models.', 141, 2911),
(10418, '2023-05-16', '2023-05-24', '2023-05-20', 'Shipped', NULL, 412, 3804),
(10419, '2023-05-17', '2023-05-28', '2023-05-19', 'Shipped', NULL, 382, 289),
(10420, '2023-05-29', '2023-06-07', NULL, 'In Process', NULL, 282, 32),
(10421, '2023-05-29', '2023-06-06', NULL, 'In Process', 'Custom shipping instructions were sent to warehouse', 124, 4296),
(10422, '2023-05-30', '2023-06-11', NULL, 'In Process', NULL, 157, 1381),
(10423, '2023-05-30', '2023-06-05', NULL, 'In Process', NULL, 314, 4021),
(10424, '2023-05-31', '2023-06-08', NULL, 'In Process', NULL, 141, 962),
(10425, '2023-05-31', '2023-06-07', NULL, 'In Process', NULL, 119, 2746);
...
(357, 'AG240323', '2021-12-16', 20210.04),
...
(487, 'PT550181', '0000-00-00', 12573.28),
...
CREATE TABLE `processing` (
  `id` int(11) NOT NULL,
  `category_column` varchar(50) DEFAULT NULL,
  `time_column` decimal(10,2) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Table structure for table `profit_trends`
--

CREATE TABLE `profit_trends` (
  `id` int(11) NOT NULL,
  `year_2022_profit` int(11) DEFAULT NULL,
  `year_2023_profit` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `profit_trends`
--

INSERT INTO `profit_trends` (`id`, `year_2022_profit`, `year_2023_profit`) VALUES
(1, 500000, 1000000),
(2, 750000, 1300000),
(3, 650000, 2000000),
(4, 900000, 1900000),
...
CREATE TABLE `qualityprocessed` (
  `id` int(11) NOT NULL,
  `category_column` varchar(50) DEFAULT NULL,
  `quality_column` decimal(10,2) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `qualityprocessed`
--

INSERT INTO `qualityprocessed` (`id`, `category_column`, `quality_column`) VALUES
(1, 'Category A', 8.50),
(2, 'Category B', 7.70),
(3, 'Category C', 9.20),
(4, 'Category A', 7.90),
...
--
-- Indexes for table `customer_satisfaction`
--
...
--
-- Indexes for table `profit_trends`
--
